...
class EntityMergingQuestionCreator(BaseQuestionCreator):
    ...
    def generate_questions(self) -> List[Question]:
        ...
        prompt = (
            ...
            '[{"id": "q1", "text": "Do \'Entity A\' and \'Entity B\' represent the same concept? Should they be merged?",entities_contained: ["Entity Id A", "Entity Id B"], "category": "merging", "priority": 6}]\n'
        )
