...
class DuplicateTripleQuestionCreator(BaseQuestionCreator):
    ...
    def generate_questions(self) -> List[Question]:
        ...
        prompt = (
            ...
            '[{"id": "q1", "text": "Triple 5: Entity A --[connects]--> Entity B. Should this be removed?",triples_referenced: ["Triple Id A", "Triple Id B"], "entities_referenced": ["Entity Id A", "Entity Id B"], "category": "mistake", "priority": 8}]\n'
        )
