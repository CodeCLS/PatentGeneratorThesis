...
class TripleMergingQuestionCreator(BaseQuestionCreator):
    ...
    def generate_questions(self) -> List[Question]:
        ...
        prompt = (
            ...
            '[{"id": "q1", "text": "Triples 5 and 7 both connect Entity A to Entity B. Should these be merged into one?",entities_contained: ["Entity Id A", "Entity Id B"], "category": "merging", "priority": 6}]\n'
        )
